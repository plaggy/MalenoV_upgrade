...
![](readme_images/malenov_test_seismic.png){:height="50%" width="50%"}

Here are some prediction examples obtained with different subcube sizes:
![](readme_images/malenov_predictions.png){:height="50%" width="50%"}
...
![](readme_images/malenov_variogram.png){:height="50%" width="50%"}
